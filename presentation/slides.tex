...
\node[inner sep=0pt] at (8, -1.6) {\includegraphics[width=.1\textwidth]{graphics/firebase.png}};
\node(FIREBASE) at (8, -2.3) {Functions};
\draw[thick] (8, -2.5) -- (8,-5);
\draw[thick,->] (8, -3.0) -- (6, -3.0) node[midway, above] {Get Users};
\draw[thick,->] (8, -3.8) -- (6, -3.8) node[midway, above] {Get New Message};
