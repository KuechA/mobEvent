...
linkcolor = black, plainpages = false, hypertexnames = false, citecolor = black, pagebackref = true, pdftex, pdfauthor={Saad Lamdouar, Berkay Köksal, Alexander Küchler}, pdftitle={Event Organizer}] {hyperref}

\titlehead{\centering\includegraphics[width=6cm]{graphics/EurecomLogo.png}}
\title{MobServ Challenge Project 2017}
\subtitle{Event Organizer for Android}
\author{Saad Lamdouar \and Berkay K\"oksal \and Alexander K\"uchler}
\date{\today}
